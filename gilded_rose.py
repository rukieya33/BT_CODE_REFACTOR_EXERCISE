            ...
            if item.quality < 50:
                ...
                # then add 3 to quality else set quality to zero.
                 ...
                 if "Conjured" in item.name and item.sell_in > 0:
                        ...
                        # if item quality is 80 and item is Sulfuras then go to next item using the continue to move the iterator to the next item in the items array.
            elif item.quality == 80 and item.name == "Sulfuras, Hand of Ragnaros":
                 continue
            # if Conjured item subtract item quality of conjured item by 2
